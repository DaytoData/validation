$(document).ready(function() {
    ...
    $('.js_validation').submit(function(){
        ...
        var success_msg = '<div class="thankyou">Thank you for your enquiry - someone will be in touch soon.</div>'
        ...
        $.ajax({
            ...
            data: $(this).serialize(),
            success: function() {
                $('.js_validation fieldset').fadeOut('fast', function(){
                     $('.js_thankyou').hide().html(success_msg).fadeIn();
                });
            }
        });
        return false;
